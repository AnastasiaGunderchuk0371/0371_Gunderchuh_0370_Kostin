...
public class EditSellerWindow extends JFrame{
	...
	public EditSellerWindow(DefaultTableModel sellersModel, JFrame shop, int[] selectedRows) {
		this.setTitle("Изменение продавца");
		...
		startDataLabel = new JLabel("<html>ФИО: " + sellersModel.getValueAt(selectedRows[selectEditableRow], 0) + 
				"<br>Дата рождения: " + sellersModel.getValueAt(selectedRows[selectEditableRow], 1) + 
				"<br>Зарплата: " + sellersModel.getValueAt(selectedRows[selectEditableRow], 2) + 
				"<html>");
		...
		editSeller = new JButton("Изменить");
			...
			public void actionPerformed(ActionEvent event) {
				try {
					...
					if(selectEditableRow + 1 < selectedRows.length) {
						selectEditableRow += 1;
						startDataLabel.setText("<html>ФИО: " + sellersModel.getValueAt(selectedRows[selectEditableRow], 0) + 
								"<br>Дата рождения: " + sellersModel.getValueAt(selectedRows[selectEditableRow], 1) + 
								"<br>Зарплата: " + sellersModel.getValueAt(selectedRows[selectEditableRow], 2) + 
								"<html>");
					}
