...
public class ProductWindow extends JFrame {
	...
	JLabel productNameLabel, priceLabel, numLabel, soldLabel;
	JTextField productNameField, priceField, numField, soldField;
	JButton addProduct;
	SpringLayout layout, layout1, layout2, layout3, layout4;

	public ProductWindow(DefaultTableModel productsModel, JFrame shop) {
